...
// Dongo accepts collation at creation time but does not enforce it.
...
// Dongo accepts the collation option but does not enforce locale-aware sort
...
// Dongo ignores this option — cursor timeout behaviour is unchanged.
