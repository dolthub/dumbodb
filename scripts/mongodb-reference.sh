...
#   - dongo regressions (passes here, fails in ferretdb-scorecard)
#   - expected failures (fails here too, not a dongo-specific problem)
#
...
echo "NOTE: Failures here are genuine MongoDB baseline results, not dongo bugs." | tee -a "$RESULTS_FILE"
