...
import (
	...
	"github.com/dolthub/dongo/internal/handler/proxy"
	"github.com/dolthub/dongo/internal/types"
	"github.com/dolthub/dongo/internal/util/lazyerrors"
	"github.com/dolthub/dongo/internal/util/logging"
	"github.com/dolthub/dongo/internal/util/must"
	"github.com/dolthub/dongo/internal/util/observability"
)
...
func (c *conn) run(ctx context.Context) (err error) {
	...
	for {
		...
		// TODO https://github.com/dolthub/dongo/issues/2412
...
func (c *conn) route(connCtx context.Context, reqHeader *wire.MsgHeader, reqBody wire.MsgBody) (resHeader *wire.MsgHeader, resBody wire.MsgBody, closeConn bool) { //nolint:lll // argument list is too long
	...
	// TODO https://github.com/dolthub/dongo/issues/273
