...
func TestDumboDBPush_FileRoundTrip(t *testing.T) {
	...
	res2, err := b.DumboDBPush(ctx, &backends.PushParams{DBName: dbName, Remote: "origin", Branch: "main"})
	if err != nil {
	...
	if _, err := b.DumboDBPush(ctx, &backends.PushParams{DBName: dbName, Remote: "origin", Branch: "main"}); err != nil {
...
func TestDumboDBPush_RemoteNotFound(t *testing.T) {
	...
	if _, err := b.DumboDBPush(ctx, &backends.PushParams{DBName: "mydb", Remote: "ghost", Branch: "main"}); err == nil {
