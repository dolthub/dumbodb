...
var unknownFieldPolicies = map[string]unknownFieldPolicy{
	...
	"doltFetch": strictRejects, "dumboFetch": strictRejects,
	"doltPull": strictRejects, "dumboPull": strictRejects,
	"doltClone": strictRejects, "dumboClone": strictRejects,
	...
	"dumboReplicationDetach": strictRejects, "dumboReplicationStatus": strictRejects,
