...
func (h *Handler) initCommands() {
	...
	h.register(&Command{Handler: h.MsgDumboDBClone, Durable: true, Help: "Creates a new database by cloning a file:// remote. Run against the admin database."}, "doltClone", "dumboClone")
