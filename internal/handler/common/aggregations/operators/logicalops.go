...
// andOp implements { $and: [ <expr1>, <expr2>, ... ] }.
// Returns true if all expressions are truthy, false otherwise.
...
// orOp implements { $or: [ <expr1>, <expr2>, ... ] }.
// Returns true if any expression is truthy, false otherwise.
...
// notOp implements { $not: [ <expr> ] }.
// Returns true if the expression is falsy, false otherwise.
