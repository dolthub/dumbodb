...
func init() {
	...
	// TODO https://github.com/dolthub/dongo/issues/4001
	if buildInfo.Main.Path != "github.com/dolthub/dongo" {
		return
	}
	...
	if !strings.HasPrefix(info.Version, "v") {
		...
		msg += "See https://pkg.go.dev/github.com/dolthub/dongo/build/version"
		panic(msg)
	}
